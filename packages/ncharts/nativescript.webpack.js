/**
 * NativeScript webpack configuration for @nstudio/ncharts
 *
...
module.exports = (webpack) => {
  ...
  const shouldAutoload = webpack.Utils.config.getValue('ncharts.svelte.autoload', true);
  if (!shouldAutoload) {
    return;
  }
  ...
  webpack.chainWebpack((config) => {
    ...
    // This pattern allows both ncharts and nstreamdown
    config.module
      .rule('svelte')
      .exclude.clear()
